...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>assets/public/css/flickity.min.css">
...
<section class="title-section text-left text-sm-center revealator-slideup revealator-once revealator-delay1">
    <h1><span><?= $nama->nama?></span></h1>
    <span class="title-bg">My Portfolio</span>
</section>
<!-- Page Title Ends -->
<!-- Main Content Starts -->
<section class="main-content text-center revealator-slideup revealator-once revealator-delay1">
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="grid-wrap">
            <ul class="row grid">
                <?php foreach($detailPortfolio as $result):?>
                    <li>
                        <figure>
                            <img src="<?= base_url('assets/upload/'.$result->nama_photo)?>" alt="Portolio Image" />
        ...
        <section class="slideshow">
                        ...
                        <figcaption>
                            ...
                            <div class="row open-sans-font">
                                <div class="col-12 col-sm-6 mb-2">
                                    <i class="fa fa-file-text-o pr-2"></i><span class="project-label">Project </span>: <span class="ft-wt-600 uppercase"><?= $result->nama?></span>
                                </div>
                                <div class="col-12 col-sm-6 mb-2">
                                    <i class="fa fa-user-o pr-2"></i><span class="project-label">Client </span>: <span class="ft-wt-600 uppercase"><?= $result->client?></span>
                                </div>
                                <div class="col-12 col-sm-6 mb-2">
                                    <i class="fa fa-code pr-2"></i><span class="project-label">Langages </span>: <span class="ft-wt-600 uppercase"><?= $result->bahasa?></span>
                                </div>
                                <div class="col-12 col-sm-6 mb-2">
                                    <i class="fa fa-external-link pr-2"></i><span class="project-label">Preview </span>: <span class="ft-wt-600 uppercase"><?= $result->link?></span>
                                </div>
                            </div>
                        </figcaption>
            ...
            <nav>
                <span class="icon nav-prev"><img src="<?= base_url()?>assets/public/img/projects/navigation/left-arrow.png" alt="previous"></span>
                <span class="icon nav-next"><img src="<?= base_url()?>assets/public/img/projects/navigation/right-arrow.png" alt="next"></span>
                <span class="nav-close"><img src="<?= base_url()?>assets/public/img/projects/navigation/close-button.png" alt="close"> </span>
            </nav>
...
<script src="<?= base_url()?>assets/public/js/flickity.pkgd.min.js"></script>
