                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <input type="hidden" name="id" id="id" value="<?= $skils->id?>">
                            <label for="nama">Nama Skils :</label>
                            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan Nama Skils Anda" autocomplete="off" value="<?= set_value('nama', $skils->nama)?>">
                            <span class="text-danger"><?= form_error('nama')?></span>
                        </div>
                        <div class="form-group">
                            <label for="persentase">Persentase Skils :</label>
                            <input type="text" name="persentase" id="persentase" class="form-control" placeholder="Masukan Angka Presentase Skils Anda" autocomplete="off" value="<?= set_value('persentase', $skils->persentase)?>">
