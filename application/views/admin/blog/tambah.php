    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/blog/addProcess')?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="judul">Judul Blog :</label>
                            <input type="text" name="judul" id="judul" autocomplete="off" class="form-control" placeholder="Masukan Judul Blogs" value="<?= set_value('judul')?>">
