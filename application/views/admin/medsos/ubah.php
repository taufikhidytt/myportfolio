                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="link" id="link" class="form-control" placeholder="Contoh: https://www.instagram.com/namaanda" value="<?= set_value('link', $medsos->link)?>">
                            <span class="text-danger"><?= form_error('link')?></span>
                        </div>
                        <div class="form-group">
                            <label for="icon">Icon Medsos :</label>
                            <input type="text" name="icon" id="icon" class="form-control" placeholder="Contoh: fa fa-instagram" value="<?= set_value('icon', $medsos->icon)?>">
