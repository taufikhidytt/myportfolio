                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control" autocomplete="off" placeholder="Masukan Nama Education Anda" value="<?= set_value('nama', $education->nama_education)?>">
                            <span class="text-danger"><?= form_error('nama')?></span>
                        </div>
                        <div class="form-group">
                            <label for="jurusan">Jurusan :</label>
                            <input type="text" name="jurusan" id="jurusan" class="form-control" autocomplete="off" placeholder="Masukan Jurusan Anda" value="<?= set_value('jurusan', $education->jurusan)?>">
                            <span class="text-danger"><?= form_error('jurusan')?></span>
                        </div>
                        <div class="form-group">
                            <label for="tahun_mulai">Tahun Mulai Education :</label>
                            <input type="text" name="tahun_mulai" id="tahun_mulai" class="form-control" autocomplete="off" placeholder="Masukan Tahun Mulai Education Anda" value="<?= set_value('tahun_mulai', $education->tahun_mulai)?>">
                            <span class="text-danger"><?= form_error('tahun_mulai')?></span>
                        </div>
                        <div class="form-group">
                            <label for="tahun_akhir">Tahun Akhir Education :</label>
                            <input type="text" name="tahun_akhir" id="tahun_akhir" class="form-control" autocomplete="off" placeholder="Masukan Tahun Akhir Education Anda Dan Jika Belum Lulus Tulis Sekarang" value="<?= set_value('tahun_akhir', $education->tahun_akhir)?>">
                            <span class="text-danger"><?= form_error('tahun_akhir')?></span>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi Education:</label>
                            <textarea name="deskripsi" id="deskripsi" class="form-control" autocomplete="off" placeholder="Masukan Deskripsi Education Anda"><?= set_value('deskripsi', $education->deskripsi)?></textarea>
