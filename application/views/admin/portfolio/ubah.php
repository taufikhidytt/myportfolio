                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" autocomplete="off" class="form-control" placeholder="Masukan Nama Project" value="<?= set_value('nama', $portfolio->nama)?>">
                            <span class="text-danger"><?= form_error('nama')?></span>
                        </div>
                        <div class="form-group">
                            <label for="bahasa">Bahasa Pemograman Di Pakai :</label>
                            <input type="text" name="bahasa" id="bahasa" autocomplete="off" class="form-control" placeholder="Masukan Bahasa Pemograman Di Pakai" value="<?= set_value('bahasa', $portfolio->bahasa)?>">
                            <span class="text-danger"><?= form_error('bahasa')?></span>
                        </div>
                        <div class="form-group">
                            <label for="client">Nama Client :</label>
                            <input type="text" name="client" id="client" autocomplete="off" class="form-control" placeholder="Masukan Nama Client" value="<?= set_value('client', $portfolio->client)?>">
                            <span class="text-danger"><?= form_error('client')?></span>
                        </div>
                        <div class="form-group">
                            <label for="link">Link Project :</label>
                            <input type="text" name="link" id="link" autocomplete="off" class="form-control" placeholder="Masukan Link Project, Jika Belum live Tulis Local" value="<?= set_value('link', $portfolio->link)?>">
